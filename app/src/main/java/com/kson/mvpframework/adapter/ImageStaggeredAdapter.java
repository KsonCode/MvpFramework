 ...
 * Description:
 */
public class ImageStaggeredAdapter extends RecyclerView.Adapter<ImageStaggeredAdapter.MyViewHolder> {
    private int height;
    private List<ImageEntity.Image> list;
    private Context mContext;

    public ImageStaggeredAdapter(Context context, List<ImageEntity.Image> list) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        layoutParams.height = App.screen_width / 2+random.nextInt(2000);
